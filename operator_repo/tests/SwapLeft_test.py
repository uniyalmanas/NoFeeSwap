...
def test_swapLeft(deployment, n, request, worker_id):
    ...
    if spacing < lower - 3 * spacing:
        ...
        sequence[5] = encode_packed(
          ['uint8', 'uint256', 'uint8', 'uint8'],
          [MODIFY_SINGLE_BALANCE, keccak(['uint256', 'int256', 'int256'], [poolId, qMin - spacing, qMax]), sharesSlot, sharesSuccessSlot]
        )
        ...
        pool.modifyPosition(qMin - spacing, qMax, shares)
