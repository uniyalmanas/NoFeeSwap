...
def test_invalidGrowthPortion(deployment, request, worker_id):
    ...
    # initialization
    unsaltedPoolId = (twosComplementInt8(-5) << 180) + (0b11111111111111111111 << 160) + toInt(hook.address)
    with brownie.reverts('InvalidGrowthPortion: ' + str(0x800000000001)):
