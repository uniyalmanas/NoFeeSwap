...
def test_searchIncomingTarget(wrapper, zeroForOne, horizontalStart, horizontalGap, verticalStart, verticalGap, _begin, _end, _solution, request, worker_id):
    ...
    if ((
        ...
        tx = wrapper._searchIncomingTarget(
            integralLimit,
            0,
            zeroForOne,
            [
        ...
        exactAmount, incoming, output = tx.return_value
